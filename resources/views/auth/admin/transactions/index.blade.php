            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 my-3">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-primary" href="{{ route('admin.transactions.create') }}">Create Transaction</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 my-3">
                ...
                <thead>
                    <tr class="table-success">
                        ...
                        <th data-sortable="true" data-field="user.name">Created By User</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="table-default">
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="{{ route('admin.transactions.show', $transaction) }}">Show</a>
                            <a class="btn btn-warning btn-sm" href="{{ route('admin.transactions.edit', $transaction) }}">Edit</a>
                            <form action="{{ route('admin.transactions.destroy', $transaction) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this transaction?');">
                                @csrf 
                                @method('DELETE')
