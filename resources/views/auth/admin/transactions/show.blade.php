            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex justify-content-between my-3">
                        ...
                        <a class="btn btn-secondary" href="{{ route('admin.transactions.index') }}" >Transaction List</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container mt-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-warning" href="{{ route('admin.transactions.edit', $transaction) }}">Update Transaction</a>
                        </div>
                    </div>
                </div>
